---
title: '<span class="lang-pt">Condicionamento de Ar para Ensaios de Motores: Fluidodinâmica e Controle Eletrônico</span><span class="lang-en">Air Conditioning for Engine Testing: Fluid Dynamics and Electronic Control</span>'
description: '<span class="lang-pt">Desenvolvimento integral de um sistema de controle de pressão e temperatura para admissão de ar em testes de motores de combustão superalimentados.</span><span class="lang-en">End-to-end development of a pressure and temperature control system for air intake in supercharged combustion engine testing.</span>'
date: "2015-08-15"
...
![<span class="lang-pt">Sistema de condicionamento térmico de ar instalado no laboratório, evidenciando as tubulações isoladas termicamente e o arranjo fluidodinâmico de aquecimento.</span><span class="lang-en">Air thermal conditioning system installed in the laboratory, highlighting the thermally insulated piping and the fluid-dynamic heating arrangement.</span>](images/DSC_0293.JPG)
...
![<span class="lang-pt">Placa de circuito impresso (PCB) customizada desenvolvida para o processamento dos algoritmos PID e disparo dos estágios de potência.</span><span class="lang-en">Custom printed circuit board (PCB) developed for processing the PID algorithms and triggering the power stages.</span>](images/controlador-ctm.jpg){width=70%}
...
![<span class="lang-pt">Modelagem 3D do encapsulamento de sensores de pressão dedicados, projetados para suportar o ambiente do ensaio e enviar dados precisos para o controlador.</span><span class="lang-en">3D modeling of the dedicated pressure sensor housing, designed to withstand the test environment and send accurate data to the controller.</span>](images/pressao.png){width=70%}
