---
title: '<span class="lang-pt">Ciência de Dados e Balanço Químico em Combustão para Créditos de Carbono</span><span class="lang-en">Data Science and Chemical Balance in Combustion for Carbon Credits</span>'
description: '<span class="lang-pt">Engenharia reversa de analisadores de gás e modelagem de emissões termoquímicas para o mercado de sustentabilidade na indústria siderúrgica.</span><span class="lang-en">Reverse engineering of gas analyzers and modeling of thermochemical emissions for the sustainability market in the steel industry.</span>'
...
![<span class="lang-pt">Sistema de amostragem e condicionamento de gases instalado no ambiente agressivo dos fornos de carbonização.</span><span class="lang-en">Sampling and gas conditioning system installed in the aggressive environment of the carbonization furnaces.</span>](images/DSC04383.JPG){width=70%}
...
![<span class="lang-pt">Gráficos de dados gerados pelos algoritmos de análise, mostrando as curvas de emissão de gases ao longo do ciclo de carbonização.</span><span class="lang-en">Data charts generated by the analysis algorithms, showing gas emission curves throughout the carbonization cycle.</span>](images/CorridaCH4.png){width=85%}
