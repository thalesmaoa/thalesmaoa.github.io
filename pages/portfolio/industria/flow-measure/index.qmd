---
title: '<span class="lang-pt">Sistemas de Medição de Fluxo Customizados: Design de Tubo Venturi e Eletrônica Integrada</span><span class="lang-en">Custom Flow Measurement Systems: Venturi Tube Design and Integrated Electronics</span>'
description: '<span class="lang-pt">Desenvolvimento ponta a ponta de medidores de vazão industriais. Do cálculo fluidodinâmico de tubos Venturi para baixíssima perda de carga até a eletrônica de aquisição de dados.</span><span class="lang-en">End-to-end development of industrial flow meters. From the fluid dynamics calculation of Venturi tubes for extremely low pressure loss to the data acquisition electronics.</span>'
...
![<span class="lang-pt">Projeto e fabricação de sistema de medição de fluxo baseado em Tubo Venturi.</span><span class="lang-en">Design and fabrication of a flow measurement system based on a Venturi Tube.</span>](images/venturi.png)
...
![<span class="lang-pt">Eletrônica para condicionamento de sinal.</span><span class="lang-en">Electronics for signal conditioning.</span>](images/eletronica.png){width=80%}
...
![](/files/images/partners/alateon.png){height=60px}
