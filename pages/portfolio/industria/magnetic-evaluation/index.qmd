---
title: '<span class="lang-pt">Avaliação de Qualidade Magnética de Aços: Metrologia e Hardware em Alta Frequência</span><span class="lang-en">Magnetic Quality Assessment of Steels: High-Frequency Metrology and Hardware</span>'
description: '<span class="lang-pt">Desenvolvimento de bancada de ensaios com inversor monofásico customizado para levantamento de perdas magnéticas e curvas B-H em geometrias reais de estatores.</span><span class="lang-en">Development of a test bench with a custom single-phase inverter for measuring magnetic losses and B-H curves in real stator geometries.</span>'
...
![<span class="lang-pt">Ensaio termográfico do núcleo do estator em operação a 1.200 Hz. O mapeamento valida o impacto térmico direto das perdas magnéticas no material de alta performance.</span><span class="lang-en">Thermographic test of the stator core in operation at 1,200 Hz. The mapping validates the direct thermal impact of magnetic losses on the high-performance material.</span>](images/banner.jpg){width=70%}
...
![<span class="lang-pt">Conversor projetado para ensaios em frequências na faixa do kHz.</span><span class="lang-en">Converter designed for testing at frequencies in the kHz range.</span>](images/h-bridge.png){width=90%}
...
![<span class="lang-pt">Curvas de Densidade de Fluxo (B) versus Intensidade de Campo (H) obtidas em bancada a 1.200 Hz, evidenciando o efeito *skin* magnético nos materiais.</span><span class="lang-en">Flux Density (B) versus Field Intensity (H) curves obtained on the bench at 1,200 Hz, evidencing the magnetic *skin* effect in the materials.</span>](images/hbcurve.png)
