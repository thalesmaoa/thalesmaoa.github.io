---
title: '<span class="lang-pt">Eletrificação Veicular e Motores In-Wheel: Da Alta Densidade ao Mercado Comercial</span><span class="lang-en">Vehicle Electrification and In-Wheel Motors: From High Density to Commercial Market</span>'
description: '<span class="lang-pt">Desenvolvimento e dimensionamento de máquinas elétricas embutidas na roda (In-Wheel) para veículos de competição de alta performance e veículos de passageiros micro-híbridos.</span><span class="lang-en">Development and design of in-wheel electric machines for high-performance competition vehicles and micro-hybrid passenger vehicles.</span>'
date: "2022-08-16"
...
![<span class="lang-pt">Motor elétrico de fluxo comutado montado no interior de uma roda comercial e posicionado sobre o rolo de um dinamômetro para ensaios de validação de frenagem regenerativa.</span><span class="lang-en">Flux-switching electric motor mounted inside a commercial wheel and positioned on the dynamometer roller for regenerative braking validation tests.</span>](images/carro_inwheel.jpg)
...
![<span class="lang-pt">Vista explodida em CAD 3D do conjunto trativo para a Fórmula SAE. O design integra um motor radial de alta rotação a uma caixa redutora planetária, tudo dimensionado para caber no interior do aro da roda.</span><span class="lang-en">Exploded 3D CAD view of the traction assembly for Formula SAE. The design integrates a high-speed radial motor with a planetary gearbox, all sized to fit inside the wheel rim.</span>](images/formula-tesla.png){width=90%}
...
![<span class="lang-pt">Análise em Elementos Finitos (FEM) da densidade de fluxo magnético para diferentes configurações de Máquinas de Fluxo Comutado (FSM). As simulações avaliaram topologias de 12s-5p, 24s-10p e 36s-15p para otimização do núcleo ferromagnético.</span><span class="lang-en">Finite Element Method (FEM) analysis of magnetic flux density for different Flux-Switching Machine (FSM) configurations. The simulations evaluated 12s-5p, 24s-10p, and 36s-15p topologies to optimize the ferromagnetic core.</span>](images/femm.jpg)
...
<!-- ![<span class="lang-pt">Integração mecânica do protótipo no eixo traseiro de um veículo comercial. O espaço ocioso entre o tambor de freio e o interior da roda foi utilizado para acoplar a máquina elétrica sem alterar a estrutura original da suspensão.</span><span class="lang-en">Mechanical integration of the prototype on the rear axle of a commercial vehicle. The idle space between the brake drum and the inside of the wheel was used to couple the electrical machine without altering the original suspension structure.</span>](images/carro_inwheel.jpg) -->
...
![<span class="lang-pt">Validação experimental do modelo numérico.</span><span class="lang-en">Experimental validation of the numerical model.</span>](images/results.jpg)
