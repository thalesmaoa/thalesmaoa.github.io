---
title: '<span class="lang-pt">Resfriamento por Imersão e Gerenciamento Térmico: Simulação CFD e Validação Experimental</span><span class="lang-en">Immersion Cooling and Thermal Management: CFD Simulation and Experimental Validation</span>'
description: '<span class="lang-pt">Especialista em thermal management e immersion cooling para eletrônica de potência e baterias veiculares (Li-ion), unindo simulação fluidodinâmica (CFD) e testes em bancada.</span><span class="lang-en">Expert in thermal management and immersion cooling for power electronics and automotive Li-ion batteries, combining computational fluid dynamics (CFD) simulation and bench testing.</span>'
date: "2023-12-20"
...
![<span class="lang-pt">Imagem termográfica evidenciando o fluxo de calor convectivo em um dispositivo de potência submerso em tanque de óleo.</span><span class="lang-en">Thermographic image showing the convective heat flow in a power device submerged in an oil tank.</span>](images/banner.jpg)
...
![<span class="lang-pt">Validação experimental.</span><span class="lang-en">Experimental validation.</span>](images/experimento.jpg)
...
![<span class="lang-pt">Simulação CFD comparando o gradiente de temperatura em um pack de baterias: o escoamento axial (à direita) garante uniformidade térmica entre as células.</span><span class="lang-en">CFD simulation comparing the temperature gradient in a battery pack: axial flow (on the right) ensures thermal uniformity among the cells.</span>](images/baterias.jpg)
...
![<span class="lang-pt"></span><span class="lang-en">UFMG logo</span>](/files/icons/logo_UFMG.jpg){height=60px}

<!-- ![<span class="lang-pt"></span><span class="lang-en">Petrobras logo</span>](/files/images/partners/Petrobras_logo.svg){height=60px} -->
