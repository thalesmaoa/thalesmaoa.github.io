---
title: '<span class="lang-pt">Diagnóstico Preditivo de Cabos Subterrâneos: Localização de Falhas Incipientes via Blindagem</span><span class="lang-en">Predictive Diagnostics of Underground Cables: Incipient Fault Location via Shielding</span>'
description: '<span class="lang-pt">Pesquisa e desenvolvimento de algoritmo baseado no método de impedância de dois terminais aplicado à blindagem metálica para detecção online de falhas (Water Tree).</span><span class="lang-en">Research and development of an algorithm based on the two-terminal impedance method applied to the metallic shielding for online fault detection (Water Tree).</span>'
date: "2025-07-04" 
...
![<span class="lang-pt">Formas de onda evidenciando a ocorrência de uma falha incipiente (subcíclica e autoextinguível) antes de sua evolução para uma falha permanente.</span><span class="lang-en">Waveforms evidencing the occurrence of an incipient fault (sub-cycle and self-extinguishing) before its evolution into a permanent fault.</span>](images/falha-incipiente.png){width=80%}
...
![<span class="lang-pt">Gráfico comparativo provando a superioridade do método: a análise via blindagem metálica (azul) apresenta erros drasticamente menores em relação ao uso do condutor principal (vermelho).</span><span class="lang-en">Comparative chart proving the method's superiority: the metallic shield analysis (blue) shows drastically smaller errors compared to the main conductor approach (red).</span>](images/comparativo.png){width=90%}
