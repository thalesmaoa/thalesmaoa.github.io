---
title: '<span class="lang-pt">Monitoramento On-Line de Isolamento (SIMOI): IoT e Predição de Falhas na Indústria de O&G</span><span class="lang-en">Online Insulation Monitoring (SIMOI): IoT and Fault Prediction in the O&G Industry</span>'
description: '<span class="lang-pt">Concepção de arquitetura embarcada, algoritmos e estratégia de computação em nuvem para detecção preditiva de degradação em motores de média tensão.</span><span class="lang-en">Design of embedded architecture, algorithms and cloud computing strategy for predictive detection of degradation in medium-voltage motors.</span>'
...
![<span class="lang-pt">Arquitetura lógica do sistema SIMOI, evidenciando o fluxo de dados desde os conversores A/D até os algoritmos de predição de falha e a infraestrutura de nuvem (IIoT).</span><span class="lang-en">Logical architecture of the SIMOI system, showing the data flow from A/D converters to fault prediction algorithms and the cloud infrastructure (IIoT).</span>](images/fluxo-dados.png)
...
![<span class="lang-pt">Topologia de hardware embarcada projetada para o SIMOI, integrando o processamento central aos módulos de aquisição de dados (DAQ) e comunicação.</span><span class="lang-en">Embedded hardware topology designed for SIMOI, integrating central processing with data acquisition (DAQ) and communication modules.</span>](images/hardware.png)
...
![<span class="lang-pt">Estratégia de telemetria e conectividade em nuvem, estruturada em níveis de segurança para garantir flexibilidade e proteção cibernética em infraestrutura crítica.</span><span class="lang-en">Cloud telemetry and connectivity strategy, structured in security levels to ensure flexibility and cyber protection in critical infrastructure.</span>](images/cloud.png)
